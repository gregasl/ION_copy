...
if NOT "%1"=="redisOrder" goto a
	set WORKINGDIR=RUN_redisOrder
	set MAINCLASS=com.iontrading.redisOrder.redisOrder
	set SRC=src\com\iontrading\redisOrder
	set SAMPLE_NAME=redisOrder
goto END_LIST
