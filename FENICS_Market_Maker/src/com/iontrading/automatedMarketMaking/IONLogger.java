...
public class IONLogger {
    ...
    /**
     * Factory method to create a logger from OrderManagement
     * @param orderManagement The OrderManagement instance to get log from
     * @param context Context name for the logger
     * @return A new IONLogger instance
     */
    public static IONLogger fromOrderManagement(OrderManagement orderManagement, String context) {
        return new IONLogger(
            orderManagement.getMkvLog(),  // Add a getter for myLog in OrderManagement
            orderManagement.getLogLevel(), // Add a getter for logLevel in OrderManagement
            context
        );
    }
}