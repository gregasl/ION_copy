...
package com.iontrading.samples.simplePatternPublisher;
...
public class Publisher {
    ...
    private static final String RECORD_PREFIX = "USD.PRICE." + SOURCE + ".";
    private static final String RECORD_ID_0 = "GEZ9";
    private static final String RECORD_ID_1 = "GEM3";
    ...
    public Publisher(String[] args) {
        ...
        try {
            ...
            publishType();
            publishPattern();
            publishRecord(RECORD_ID_0);
            supplyRecord(RECORD_ID_0, 100.50, 99.75, 5);
            publishRecord(RECORD_ID_1);
            supplyRecord(RECORD_ID_1, 100.20, 99.45, 6);
     ...
     * Publish the type.
     */
    private void publishPattern() {
        try {
            MkvPattern pattern = new MkvPattern(RECORD_PREFIX, TYPE_NAME);
            pattern.publish();
        } catch (MkvException e) {
            e.printStackTrace();
        }
