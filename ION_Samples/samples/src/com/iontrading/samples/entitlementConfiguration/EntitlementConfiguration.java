...
public class EntitlementConfiguration
{
	...
	private static class PublishListener implements MkvPublishListener 
	{
		...
		private static final String SUBSCRIBE_FEATURE = "Subscribe";
		
		private static final String TRADE_TYPE = "*";
		private static final String TRADE_NAME = "*";
		private static final String TRADE_CONTAINER = "CM_INSTRUMENT";
		private static final String TRADE_OBJ = "XXY001";
		private static final String TRADE_FEATURE = "Trade";
		...
		public void onPublishIdle(String component, boolean start) 
		{
			...
			{	
				...
				Object[] addConfigurationArguments = new Object[] {
					"ES_C_AUTHORIZATION",                     /* The configuration table you want to change */
					"ID", ruleId,                             /* A unique rule id to add to the ES collection */
					"ServiceType", "EUR",                     /* The ION record currency */
					"ServiceName", "SOURCE",                  /* The ION record source */
					"ServiceContainer", "CM_DEPTH",           /* The ION record table */
					"ServiceObject", "ABC001",                /* The ION record name */
					"Feature", SUBSCRIBE_FEATURE,             /* Subscribe for data entitlements */
			...
			/* Old-style ByFeature Entitlements */
			if(serverIsAvailable) 
			{				
				/* All parameters should be specified for SET. It simulates ADD or RWT on purpose. */
				Object[] setConfigurationArguments = new Object[] {
					"ES_C_AUTHORIZATION",                     /* The configuration table you want to change */
					"ID", ruleId,                             /* A unique rule id to add to the ES collection */
					"ServiceType", TRADE_TYPE,
					"ServiceName", TRADE_NAME,
					"ServiceContainer", TRADE_CONTAINER,
					"ServiceObject", TRADE_OBJ,
					"Feature", TRADE_FEATURE,                 /* A feature of the collection */
					"Permission", Permission.DENY.ordinal(),  /* Boolean: 1 = ALLOW, 0 = DENY */
					"UserGroup", EntityType.USER.ordinal(),   /* 0 = User, 1 = Group, 2 = Profile */
					"UserGroupName", userName                 /* The user/group/profile name */
				};				
				...
				try 
				{
					...
					addFunction.call(MkvSupplyFactory.create(setConfigurationArguments), listener);					
				} catch(Exception e) { e.printStackTrace(); }
			}
		}		
	}
