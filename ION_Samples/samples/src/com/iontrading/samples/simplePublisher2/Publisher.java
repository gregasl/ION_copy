...
public class Publisher {
    ...
    public Publisher(String[] args) {
        ...
        try {
            ...
            MyPrice price = new MyPrice();
            price.setID(RECORD_ID);
            price.setASK(new Double(100.5));
            price.setBID(new Double(99.5));
            price.setQTY(new Double(5));
     ...
     */
    private void supplyRecord(MyPrice p) {
        proxy.set(p);
        try {
            record.supply(proxy);
