...
public class IONLogger {
    ...
    /**
     * Factory method to create a logger from Subscriber
     * @param marketDataSubscriber The Subscriber instance to get log from
     * @param context Context name for the logger
     * @return A new IONLogger instance
     */
    public static IONLogger fromSubscriber(marketDataSubscriber Subscriber, String context) {
        return new IONLogger(
            Subscriber.getMkvLog(),  // Add a getter for myLog in Subscriber
            Subscriber.getLogLevel(), // Add a getter for logLevel in Subscriber
            context
        );
    }
}