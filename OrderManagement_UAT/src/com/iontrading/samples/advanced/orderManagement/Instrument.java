...
public class Instrument {
    ...
    public Boolean getIsAON() { return isAON; }
    public void setIsAON(Boolean isAON) { this.isAON = isAON; }
    ...
    public void buildSourceMappings() {
        ...
        for (int i = 0; i <= 15; i++) {
            ...
            if (src != null && !src.isEmpty() && id != null) {
                ...
                String aonCacheKey = src + "_AON";
                if (isAon) {
                    sb.append("  Adding AON mapping: ").append(aonCacheKey)
                    .append(" -> ").append(id).append("\n");
                    sourceToNativeIdMap.put(aonCacheKey, id);
                }
            }
        }
