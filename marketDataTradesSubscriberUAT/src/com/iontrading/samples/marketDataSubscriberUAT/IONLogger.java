...
public class IONLogger {
     ...
     * @param marketDataSubscriberUAT The Subscriber instance to get log from
     * @param context Context name for the logger
     * @return A new IONLogger instance
     */
    public static IONLogger fromSubscriber(marketDataSubscriberUAT Subscriber, String context) {
